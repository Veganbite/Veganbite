...
class Calculator extends React.Component {
  ...
  caloricCalculator = () => {
    ...
    if (
      ...
      let normalCaloricIntake = this.physicalActivityCalculator(
        basalCaloricIntake,
        this.state.physicalActivity
      );
      let finalCaloricIntake = this.calculateFinalCaloricIntake(
        normalCaloricIntake,
        this.state.goals
      );
  ...
  render() {
    return (
      <div
        style={{ backgroundImage: `url(${unnamed})`, paddingBottom: "10px" }}
      >
        <Container>
          <Row>
              ...
              >
                <Card.Body className="d-flex justify-content-center align-items-center">
                  <Card.Title className="text-center">
                    Your Caloric Intake (kcal):{" "}
                    <u>{this.state.caloricIntake}</u>
                  </Card.Title>
                </Card.Body>
              </Card>
            </Col>
